...
function SvgFacebook(props) {
  return (
    <a href={"https://www.facebook.com/viabichosapiranga/"} >
      <svg height={80} viewBox="0 0 24 24" width={80} {...props} >
        <path
...
//<a href ="https://www.facebook.com/viabichosapiranga/" > <circle cx="50" cy="40" r="100"/> </a>